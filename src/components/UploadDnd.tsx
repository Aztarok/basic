...
const UploadDnd = () => {
	...
	return preview ? (
		<div className="relative max-w-[500px] max-h-[300px] flex items-center justify-center text-white">
			{loading && (
				<div
					className="absolute top-0 left-0 rig0
         bottom-0 w-full h-full bg-slate-300 animate-pulse"
				></div>
			)}
			<Image
